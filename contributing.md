...
2. Add a folder to **public/logos** named after your company. In this folder, put the svg and png versions of your logo. The files should have the same name as the folder and should be lowercase. If your company name has multiple words, kindly separate them with an underscore.

### Folder Structure

```
public/logos/company_name
├── company_name.png
└── company_name.svg
```

3. In **[public/logos.json](https://github.com/PaystackHQ/nigerialogos/blob/master/public/logos.json)**, add a `JSON` entry for your company
...
4. If your company category is not reflected in categories section _below_, feel free to use a new category.
   ...
   **NB:** Your jsonObject category can also be a combined form 2 or more categories in this form:

   ```json
   "category": ["NGO", "Ecommerce"]
   // or
   "category": ["NGO", "Ecommerce", "Marketplace"]
   // or
   "category": ["NGO"]
   ```
